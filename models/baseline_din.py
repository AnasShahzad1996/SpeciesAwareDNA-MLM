...
class DiNucDist(nn.Module):
    def __init__(self) -> None:
        ...
        self.di_dist = torch.log(torch.tensor([
                                                 [distr['AA'], distr["AC"], distr["AG"], distr["AT"], 0.000001],
                                                 [distr['CA'], distr["CC"], distr["AG"], distr["AT"], 0.000001],
                                                 [distr['GA'], distr["GC"], distr["GG"], distr["GT"], 0.000001],
                                                 [distr['TA'], distr["TC"], distr["TG"], distr["TT"], 0.000001],
    ...
    def forward(self, x, xs):
        ...
        out = torch.matmul(x.transpose(1,-1),self.di_dist).transpose(1,-1)
        out[1:] = out[:-1].clone()
